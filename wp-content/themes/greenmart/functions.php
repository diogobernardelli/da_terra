 ...
 * @since greenmart 2.0
 */
define( 'GREENMART_THEME_VERSION', '2.0' );
...
define( 'GREENMART_MIN_JS', 	'.min' );

define( 'GREENMART_ACTIVE_MIN', 	true );
...
function greenmart_tbay_scripts() { 
	...
	//load font ico-font
	wp_enqueue_style( 'icofont', GREENMART_STYLES . '/icofont.css', array(), '1.0.0' );
	...
	wp_enqueue_script('jquery-sumoselect', GREENMART_SCRIPTS . '/jquery.sumoselect' . GREENMART_MIN_JS . '.js', array(), '3.0.2', TRUE);


	// load fancybox
	wp_enqueue_style( 'jquery-fancybox', GREENMART_STYLES . '/jquery.fancybox.css', array(), '3.2.0' );
	wp_enqueue_script( 'jquery-fancybox', GREENMART_SCRIPTS . '/jquery.fancybox' . GREENMART_MIN_JS . '.js', array( 'jquery' ), '20150315', true );
	
	wp_enqueue_script( 'greenmart-skip-link-fix', GREENMART_SCRIPTS . '/greenmart-skip-link-fix' . GREENMART_MIN_JS . '.js', array(), '20141010', true );
	...
	wp_enqueue_script( 'jquery-treeview', GREENMART_SCRIPTS . '/jquery.treeview' . GREENMART_MIN_JS . '.js', array( 'jquery' ), '20150330', true );
	
	wp_enqueue_script( 'bootstrap', GREENMART_SCRIPTS . '/bootstrap' . GREENMART_MIN_JS . '.js', array( 'jquery' ), '20150330', true );
	

	wp_dequeue_script('wpb_composer_front_js');
	wp_enqueue_script( 'wpb_composer_front_js');
	
	wp_enqueue_script( 'owl-carousel', GREENMART_SCRIPTS . '/owl.carousel' . GREENMART_MIN_JS . '.js', array( 'jquery' ), '2.3.4', true );

	wp_enqueue_script( 'greenmart-woocommerce', GREENMART_SCRIPTS . '/woocommerce' . GREENMART_MIN_JS . '.js', array( 'jquery' ), GREENMART_THEME_VERSION, true );

	wp_enqueue_script( 'jquery-countdowntimer', GREENMART_SCRIPTS . '/jquery.countdownTimer' . GREENMART_MIN_JS . '.js', array( 'jquery' ), '1.0.0', true );

	wp_register_script( 'greenmart-script',  GREENMART_SCRIPTS . '/functions' . GREENMART_MIN_JS . '.js', array( 'jquery' ), GREENMART_THEME_VERSION, true );
	wp_localize_script( 'greenmart-script', 'greenmart_ajax', array( 'ajaxurl' => admin_url( 'admin-ajax.php' )));

	wp_register_script( 'greenmart-skins-script', GREENMART_SCRIPTS_SKINS . '/'.$skin.'/functions' . GREENMART_MIN_JS . '.js', array( 'greenmart-script' ), GREENMART_THEME_VERSION, true );
 ...
 *
 */
function greenmart_tbay_disable_srcset( $sources ) {
    return false;
}
//add_filter( 'wp_calculate_image_srcset', 'greenmart_tbay_disable_srcset' );
