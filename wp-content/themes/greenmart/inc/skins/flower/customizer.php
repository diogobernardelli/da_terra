...
function greenmart_tbay_customize_control_js() {
	wp_enqueue_script( 'color-scheme-control', get_template_directory_uri() . '/js/color-scheme-control' . GREENMART_MIN_JS . '.js', array( 'customize-controls', 'iris', 'underscore', 'wp-util' ), '20141216', true );
...
function greenmart_tbay_customize_preview_js() {
	wp_enqueue_script( 'greenmart-customize-preview', get_template_directory_uri() . '/js/customize-preview' . GREENMART_MIN_JS . '.js', array( 'customize-preview' ), '20141216', true );
}
