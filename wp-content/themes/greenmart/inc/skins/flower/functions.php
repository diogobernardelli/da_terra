...
if ( !function_exists('greenmart_tbay_remove_icofont') ) {
	function greenmart_tbay_remove_icofont() {
	   wp_deregister_style( 'icofont' );
	}
	add_action( 'wp_enqueue_scripts', 'greenmart_tbay_remove_icofont', 100 );
}
...
if ( ! function_exists( 'greenmart_tbay_render_breadcrumbs' ) ) {
	function greenmart_tbay_render_breadcrumbs() {
		...
		echo '</div><h1 class="page-title">'.$page_title.'</h1></div></section>';
	}
}
