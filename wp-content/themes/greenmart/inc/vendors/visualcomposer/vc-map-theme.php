...
if ( !function_exists('greenmart_tbay_load_load_theme_element')) {
	function greenmart_tbay_load_load_theme_element() {
		...
		// Tbay Instagram
		vc_map( array(
		    "name" => esc_html__('Tbay Instagram','greenmart'),
		    "base" => "tbay_instagram",
		    "icon" => "vc-icon-tbay",
		    "class" => "",
		    "description"=> esc_html__('Show images Instagram', 'greenmart'),
		    "category" => esc_html__('Tbay Elements', 'greenmart'),
		    "params" => array(
		    	array(
					"type" => "textfield",
				...
				array(
					"type" 			=> "textfield",
					"heading" 		=> esc_html__('@username', 'greenmart'),
					"param_name" 	=> "username",
					"value" 		=> '',
					"admin_label"	=> true,
				...
				array(
					"type" => "textfield",
					"heading" => esc_html__('Number of photos:', 'greenmart'),
					"param_name" => "number",
					"value" => '',
					'std' => '6'
				),
				array(
					'type' 			=> 'dropdown',
					'heading' 		=> esc_html__( 'Photo size:', 'greenmart' ),
					'param_name' 	=> 'size',
					'description' 	=> esc_html__( 'Choose Type Photo size', 'greenmart' ) ,
					"admin_label"	=> true,
					'value'       	=> array(
						'thumbnail'   	=> 'thumbnail',
						'small'   		=> 'small',
				...
				array(
					'type' 			=> 'dropdown',
					'heading' 		=> esc_html__( 'Open links in:', 'greenmart' ),
					'param_name' 	=> 'target',
					'description' 	=> esc_html__( 'Choose Open links in', 'greenmart' ) ,
					'value'       	=> array(
						esc_html__('Current window (_self)', 'greenmart')  	=> '_self',
						esc_html__('New window (_blank)', 'greenmart')   	=> '_blank'
					),
					'std' => '_blank',
					'save_always' => true,
				),	
				...
				array(
					...
					'heading' => esc_html__( 'Style:', 'greenmart' ),
					'param_name' => 'style',
					'description' => esc_html__( 'Choose Style Photo Hover', 'greenmart' ) ,
					'value'       => array(
						'Style 1'  		=> 'style1',
						'Style 2'   	=> 'style2'
					),
...
class WPBakeryShortCode_tbay_counter extends WPBakeryShortCode {
	...
	public function load_scripts() {
		wp_register_script('jquery-counterup', get_template_directory_uri().'/js/jquery.counterup' . GREENMART_MIN_JS . '.js', array('jquery'), false, true);
	}
}
