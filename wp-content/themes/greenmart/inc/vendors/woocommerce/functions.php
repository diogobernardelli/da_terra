...
if ( !function_exists('greenmart_tbay_woocommerce_enqueue_styles') ) {
    function greenmart_tbay_woocommerce_enqueue_styles() {
        ...
        wp_enqueue_script( 'slick', GREENMART_SCRIPTS . '/slick' . GREENMART_MIN_JS . '.js', array( 'jquery' ), '1.0.0', true );
...
if ( !function_exists('greenmart_tbay_woocommerce_redirect_page_cart_mobile') ) {
    // define the woocommerce_add_to_cart_redirect callback 
    function greenmart_tbay_woocommerce_redirect_page_cart_mobile( $wc_get_cart_url ) { 
...
if ( !function_exists('greenmart_tbay_woocommerce_disable_redirect_page_cart_mobile') ) {
    // define the woocommerce_add_to_cart_redirect callback 
    function greenmart_tbay_woocommerce_disable_redirect_page_cart_mobile( ) { 

        $active = greenmart_tbay_get_config('disable_redirect_add_to_cart', false);

        if( !$active ) {
            add_filter( 'woocommerce_add_to_cart_redirect', 'greenmart_tbay_woocommerce_redirect_page_cart_mobile', 10, 1 );   
        }
        
    }; 
}
add_action( 'wp_loaded', 'greenmart_tbay_woocommerce_disable_redirect_page_cart_mobile', 10, 1 ); 
...
function greenmart_tbay_enqueue_cart_qty_ajax() {
    ...
    wp_register_script( 'cart-qty-ajax-js', GREENMART_SCRIPTS . '/cart-qty-ajax' . GREENMART_MIN_JS . '.js', array( 'jquery' ), '', true );
