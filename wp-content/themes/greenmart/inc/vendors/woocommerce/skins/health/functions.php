...
if ( !function_exists('greenmart_tbay_woocommerce_breadcrumb_health') ) {
    ...
    /*
        ...
        $args['wrap_before'] = '<section id="tbay-breadscrumb" class="tbay-breadscrumb"'.$estyle.'><div class="container">'.$img.'<div class="breadscrumb-inner"><ol class="tbay-woocommerce-breadcrumb breadcrumb" ' . ( is_single() ? 'itemprop="breadcrumb"' : '' ) . '>';
