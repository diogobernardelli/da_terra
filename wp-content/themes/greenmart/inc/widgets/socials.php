...
class greenmart_Tbay_Socials_Widget extends Tbay_Widget {
    ...
    public function scripts() {
        wp_enqueue_script( 'greenmart-script-admin-js', get_template_directory_uri().'/js/admin/admin' . GREENMART_MIN_JS . '.js', array( 'jquery' ), TBAY_FRAMEWORK_VERSION, true );
    }
...
register_widget( 'greenmart_Tbay_Socials_Widget' );