<?php if ( greenmart_tbay_get_config('show_searchform') ): ?>
	...
	?>
	<div class="tbay-search-form <?php echo ($is_category) ? 'is-category' : ''; ?>">
			...
			<div class="form-group">
				<div class="input-group">
					<?php if ( greenmart_tbay_get_config('search_type') != 'all' && $is_category ): ?>
				  	...
				  	<?php endif; ?>
				  		<input type="text" placeholder="<?php esc_html_e( 'I&rsquo;m searching for...', 'greenmart' ); ?>" name="s" required oninvalid="this.setCustomValidity('<?php esc_html_e('Enter at least 2 characters', 'greenmart'); ?>')" oninput="setCustomValidity('')"  class="tbay-search form-control input-sm"/>
