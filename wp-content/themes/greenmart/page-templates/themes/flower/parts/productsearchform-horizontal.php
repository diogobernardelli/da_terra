			...
			<div class="form-group">
				<div class="input-group">
					<?php if ( greenmart_tbay_get_config('search_type') != 'all' && greenmart_tbay_get_config('search_category') ): ?>
				  	...
				  	<?php endif; ?>
				  		<input data-style="horizontal" type="text" placeholder="<?php esc_html_e( 'Search for product...', 'greenmart' ); ?>" name="s" required oninvalid="this.setCustomValidity('<?php esc_html_e('Enter at least 2 characters', 'greenmart'); ?>')" oninput="setCustomValidity('')"  class="tbay-search form-control input-sm"/>
