	...
	<?php
	  ...
	  <div class="row">
	    ...
	    <div class="entry-content col-md-7 <?php echo ( !has_post_thumbnail() ) ? 'no-thumb' : ''; ?>">
			...
			<?php
			if ( has_excerpt() ) { ?>
					<div class="entry-excerpt"><?php echo greenmart_tbay_substring( get_the_excerpt(), 20, '[...]' ); ?><a href="<?php the_permalink(); ?>" title="<?php esc_html_e( 'Read More', 'greenmart' ); ?>"><?php esc_html_e( 'Read more', 'greenmart' ); ?></a></div>
				<?php } else {
					?>
						<div class="entry-description"><?php echo greenmart_tbay_substring( get_the_content(), 20, '[...]' ); ?><a href="<?php the_permalink(); ?>" title="<?php esc_html_e( 'Read More', 'greenmart' ); ?>"><?php esc_html_e( 'Read more', 'greenmart' ); ?></a></div>
					<?php
				}
			?>
	    </div>
