    ...
    <article class="post row">   
        ...
        <div class="entry-content col-md-6">
           ...
           <div class="entry">
				...
				<div class="readmore">
					<a href="<?php the_permalink(); ?>" title="<?php esc_html_e( 'Read More', 'greenmart' ); ?>"><?php esc_html_e( 'Read More', 'greenmart' ); ?><i class="<?php echo greenmart_get_icon('icon_readmore2'); ?>"></i></a>
				</div>
			</div>
        </div>
    </article>
