...
wp_enqueue_script( 'jquery-counter', get_template_directory_uri().'/js/jquery.counterup' . GREENMART_MIN_JS . '.js', array( 'jquery' ) );
wp_enqueue_script( 'waypoints', get_template_directory_uri().'/js/waypoints' . GREENMART_MIN_JS . '.js', array( 'jquery' ) );
