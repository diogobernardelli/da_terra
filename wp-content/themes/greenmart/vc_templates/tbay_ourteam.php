...
?>
	<div class="widget widget-ourteam no-margin <?php echo esc_attr($el_class); ?>">
	    ...
	    <div class="widget-content"> 
			<div class="owl-carousel products" data-navleft="<?php echo greenmart_get_icon('icon_owl_left'); ?>" data-navright="<?php echo greenmart_get_icon('icon_owl_right'); ?>" data-items="<?php echo esc_attr($columns); ?>" data-carousel="owl" data-pagination="false" data-nav="true" data-uncarouselmobile="false">
