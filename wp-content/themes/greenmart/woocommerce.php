				...
				<div id="content" class="site-content" role="main">
				 ...
				 if ( is_singular( 'product' ) ) {
		            ...
		            <?php if ( have_posts() ) : ?>
						...
						<?php if((is_shop() && 'subcategories' !== get_option('woocommerce_shop_page_display')) ||(is_product_category() && 'subcategories' !== get_option('woocommerce_category_archive_display'))  || is_tax('yith_product_brand') || is_tax('product_tag') ): ?>	
						...
						<?php if( (is_shop() && 'subcategories' !== get_option('woocommerce_shop_page_display')) ||(is_product_category() && 'subcategories' !== get_option('woocommerce_category_archive_display')) || (is_product_category() && 'subcategories' !== get_option('woocommerce_category_archive_display')) || is_tax('yith_product_brand') || is_tax('product_tag')  ): ?>
