	...
	<div class="row">
		...
		<div class="col-xs-12 col-md-9">
				...
				foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
					...
					if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
						...
						<div class="<?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?> clearfix">
							...
							<span class="product-subtotal price">
								<b><?php
			...
			<div class="cart-bottom clearfix">
				<div class="pull-left update-cart">
					<input type="submit" class="btn btn-default update" name="update_cart" value="<?php esc_html_e( 'Update Cart', 'greenmart' ); ?>" />
		...
		<div class="col-xs-12 col-md-3">
			...
			<div class="coupon">
				...
				<div class="box"><input type="text" name="coupon_code" id="coupon_code" value="" class="text" /><span class="input-group-btn"><input type="submit" class="btn btn-default" name="apply_coupon" value="<?php esc_html_e( 'Apply', 'greenmart' ); ?>" /></span></div>
